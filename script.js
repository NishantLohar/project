/*var obj = { 
    ...
    obj.basket.productList.forEach(function(element) {
            cartItemsList.insertAdjacentHTML( 'beforeend',"<div class='col-12 col-md-4 col-lg-4 mb-5 mb-md-0'><a class='product-item' href='cart.html'><img src='"+ element.product.image + "' class='img-fluid product-thumbnail'><h3 class='product-title'>" + element.product.name + "</h3><strong class='product-price'>" + element.price + "</strong>" + "</a><span class='icon-cross'><img src='images/cross.svg' class='img-fluid'></span></div>");
    });
